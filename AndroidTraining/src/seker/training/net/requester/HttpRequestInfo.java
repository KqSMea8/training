...
public class HttpRequestInfo {
    ...
    /** HTTP请求类型{@link HTTP_GET}或{@link HTTP_POST}或{@link HTTP_PUT} */
    final byte type;
     ...
     * 
     * @param url   URL
     * @param type  HTTP请求类型{@link HTTP_GET}或{@link HTTP_POST}或{@link HTTP_PUT}
     */
    public HttpRequestInfo(String url, byte type) { // SUPPRESS CHECKSTYLE
        this(url, type, TIME_OUT);
    }
     ...
     * @param time  HTTP请求时长
     */
    public HttpRequestInfo(String url, byte type, int time) { // SUPPRESS CHECKSTYLE
        this(url, type, time, AUTH_NONE);
    }
     ...
     * @param type  HTTP请求类型{@link HTTP_GET}或{@link HTTP_POST}或{@link HTTP_PUT}
     * @param time  HTTP请求时长
     * @param auth   认证方式（暂时未使用）
     */
    public HttpRequestInfo(String url, byte type, int time, byte auth) { // SUPPRESS CHECKSTYLE
        this.url = url;
        this.type = type;
        this.time = time;
        this.auth = AUTH_NONE;
     ...
     * HTTP请求类型
     * 
     * @return 该HTTP的请求类型 {@link HTTP_GET}或{@link HTTP_POST}或{@link HTTP_PUT}
     */
    public byte type() {
        return type;
    }
